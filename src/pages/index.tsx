      ...
      <div className={styles.hero}>
        <div>
          <div style={{ flexWrap: 'wrap', display: 'flex', justifyContent: 'center' }}>
            ...
            <Link to={'/operator'}><img className='indicator target' style={{ boxShadow: '0 0 40px #00a1de', border: '4px solid #00a1de'  }} src="https://images.unsplash.com/photo-1661961110671-77b71b929d52" alt="Operator Logo" /></Link>
